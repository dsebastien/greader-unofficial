...
//        OAuthConsumer consumer = new DefaultOAuthConsumer("matthiaskaeppler.de",
 //               "etpfOSfQ4e9xnfgOJETy4D56");
        OAuthConsumer consumer = new DefaultOAuthConsumer("anonymous",
        "anonymous");
    	
    	
        String scope = "http://www.google.com/reader/api";
        ...
        URL url = new URL("http://www.google.com/reader/api/0/subscription/list?output=json");
